  ...
  return (
    <MotionConfig transition={{ type: "spring", duration: 0.5, bounce: 0.2 }}>
      <motion.div
        ...
        className="relative flex h-[600px] flex-col items-center justify-center px-8"
      >
        <ul className="grid grid-cols-2 gap-8 md:grid-cols-4 w-full max-w-4xl">
          <AnimatePresence>
            {!readyToRemove &&
                ...
                return (
                  ...
                  >
                    <motion.div
                      ...
                      className={clsx(
                        "pointer-events-none absolute right-3 top-3 z-10 flex h-6 w-6 items-center justify-center rounded-full border-2 border-white bg-black/20", // Enhanced selection indicator
                        ...
                        {isSelected ? (
                          ...
                          >
                            ...
                            <svg
                              ...
                              className="relative h-4 w-4 flex-shrink-0 rounded-full text-black"
                              viewBox="0 0 24 24"
                              fill="none"
                            >
                              <path
                    ...
                    <button
                      ...
                      className="group relative w-full overflow-hidden rounded-2xl" // Added group for hover effects
                    >
                      <motion.img
                        layoutId={`image-${image}`}
                        className="h-full w-full object-cover transition-transform duration-300 group-hover:scale-105" // Added hover zoom effect
                        alt={`${image} scene`}
